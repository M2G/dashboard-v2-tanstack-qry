...
export enum AuthActionTypes {
  ...
  AUTH_CREATE_USER_PROFIL_REQUEST = '@@auth/AUTH_CREATE_USER_PROFIL_REQUEST',
  ...
  AUTH_CREATE_USER_PROFIL_SUCCESS = '@@auth/AUTH_CREATE_USER_PROFIL_SUCCESS',
  ...
  AUTH_CREATE_USER_PROFIL_ERROR = '@@auth/AUTH_CREATE_USER_PROFIL_ERROR',
